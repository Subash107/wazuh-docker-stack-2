#!/bin/bash
# Ubuntu Installation Script - All agents and monitoring services
...
echo ""
echo "Access Points:"
echo "  Pi-hole: http://192.168.1.6 (Password: set before deployment)"
echo "  Mitmproxy: http://192.168.1.6:8080"
echo "  Suricata Eve logs: /var/log/suricata/eve.json"
echo ""
